                ...
                if (isETEmpty(nombreUsuario) && isETEmpty(correo) && isETEmpty(clave)
                    ...
                    if (isEmailValid(correo.getText().toString())) {
                        if (clave.getText().toString().equals(confirmarClave.getText().toString())) {
                            ...
                            confirmarClave.setError("Las constraseñas no coinciden");
                        }
                    }else{
                        correo.setError("Correo inválido");
                    }
                }else{
                    correo.setError("No puede ir vacío");
                    nombreUsuario.setError("No puede ir vacío");
                    clave.setError("No puede ir vacío");
                    confirmarClave.setError("No puede ir vacío");
                }
            }
        });
