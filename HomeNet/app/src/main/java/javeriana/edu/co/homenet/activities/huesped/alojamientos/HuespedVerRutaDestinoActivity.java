...
public class HuespedVerRutaDestinoActivity extends FragmentActivity implements OnMapReadyCallback {

    private GoogleMap mMap;
    final static int MY_PERMISSIONS_REQUEST_LOCATION = 1;
    final static int RADIUS_OF_EARTH_KM =  6371;
    //public static final double lowerLeftLatitude = 1.396967;
    //ublic static final double lowerLeftLongitude= -78.903968;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_huesped_ver_ruta_destino);
        mAuth = FirebaseAuth.getInstance();
        FirebaseUser user = mAuth.getCurrentUser();
        requestPermission(HuespedVerRutaDestinoActivity.this, Manifest.permission.ACCESS_FINE_LOCATION,
        ...
        actualMarkerOptions.title("Posición actual");
        mLocationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                if (location != null && mMap != null) {
                    ...
                    Alojamiento aloj = (Alojamiento) bundle.getSerializable("Aloj");
                    ...
                    if(!entro){
                        entro = true;
                        //LatLng position = new LatLng(4.728102500000013, -74.06656640624999);
                        LatLng position = new LatLng(aloj.getUbicacion().getLatitude(), aloj.getUbicacion().getLongitude());
                        if (mMap != null) {
                            ...
                            mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(actualPosition, 14));
                    }
                    }
                ...
                switch (statusCode) {
                    case CommonStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {// Show the dialog by calling startResolutionForResult(), and check the result in onActivityResult().
                            ...
                            resolvable.startResolutionForResult(HuespedVerRutaDestinoActivity.this, REQUEST_CHECK_SETTINGS);
